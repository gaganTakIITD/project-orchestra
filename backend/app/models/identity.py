...
# --- 5 original campus talent (campus_verified=True) ---
DEMO_WORKER_ID = uuid.UUID("00000000-0000-4000-8000-000000000020")  # Rohan
...
DEMO_WORKER_DEV_ID = uuid.UUID("00000000-0000-4000-8000-000000000024")  # Arjun
# --- 5 fake demo fillers (campus_verified=False) ---
...
DEMO_WORKER_FAKE_RIA_ID = uuid.UUID("00000000-0000-4000-8000-000000000027")
...
SEED_WORKER_POOL_IDS = SEED_ORIGINAL_WORKER_IDS + SEED_FAKE_WORKER_IDS
